...
echo "⏳ 等待服务启动..."
sleep 12
HTTP_CODE=$(ssh "$SERVER" "curl -s -o /dev/null -w '%{http_code}' http://127.0.0.1:18081/api/v1/auth/trial/register -X POST -H 'Content-Type: application/json' -d '{}'" 2>/dev/null || echo "000")
