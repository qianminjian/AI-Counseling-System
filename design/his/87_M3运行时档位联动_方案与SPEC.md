...
> 状态：**已合并归档（2026-08-11，DOC-115，his/87）**——RUNTIME-001~005 全部实施（commit 9372844，AC-1~11） | 创建：2026-08-10 | 编号：87（doing 区接续；与 frozen/87 LLM 成本跟踪同号异题，文件名可区分）
> 实施（2026-08-11）：tts/voice 覆盖键消费（redis-py 直连 fail-open）+ 后端 TTL 7 天 + compose 透传；回归 tts 99 + voice 46+1 + 后端 1096+454 全绿；AC-10 管理端一致性留部署后联调
