...
| DOC-002 | 创建 design/docs/ 和 design/his/ 目录 | ✅ 完成 | Agent | 2026-07-23 | 2026-07-23 | |
| DOC-003 | 移动 docx 到 design/his/ | ✅ 完成 | Agent | 2026-07-23 | 2026-07-23 | git mv 保留历史 |
...
| DOC-007 | 转换 02_Prompt体系设计 为 md | ⏳ 待开始 | Agent | - | - | |
| DOC-008 | 转换 03_CBT对话流程树 为 md | ⏳ 待开始 | Agent | - | - | |
| DOC-009 | 转换 04_风险识别规则库 为 md | ⏳ 待开始 | Agent | - | - | |
| DOC-010 | 转换 05_老师后台设计 为 md | ⏳ 待开始 | Agent | - | - | |
| DOC-011 | 转换 06_数据库结构设计 为 md | ⏳ 待开始 | Agent | - | - | |
| DOC-012 | 转换 07_SaaS多学校隔离 为 md | ⏳ 待开始 | Agent | - | - | |
| DOC-013 | 转换 08_MVP最小可行版本 为 md | ✅ 完成 | Agent | 2026-07-23 | 2026-07-23 | 431 行，完整转换 |
| DOC-014 | 转换 09_商业模式与采购 为 md | ⏳ 待开始 | Agent | - | - | |
| DOC-015 | 转换 10_政策与合规风险 为 md | ⏳ 待开始 | Agent | - | - | |
| DOC-016 | 转换 11_竞品深度分析 为 md | ⏳ 待开始 | Agent | - | - | |
| DOC-017 | 转换 12_技术架构图 为 md | ⏳ 待开始 | Agent | - | - | 部分过度设计已裁决 |
| DOC-018 | 转换 13_Agent工作流 为 md | ⏳ 待开始 | Agent | - | - | 需更新：LangGraph→Spring AI |
| DOC-019 | 转换 14_儿童安全对话规范 为 md | ⏳ 待开始 | Agent | - | - | |
| DOC-020 | 转换 15_心理知识库建设 为 md | ⏳ 待开始 | Agent | - | - | |
| DOC-021 | 更新 STRUCTURE.md 反映 docs/his 结构 | ⏳ 待开始 | Agent | - | - | |
| DOC-022 | 更新 BEACON.md 引用新文档结构 | ⏳ 待开始 | Agent | - | - | |
...
|--------|----------|------|------|--------|----------|
| RISK-001 | 15 份 docx 内容量大，md 转换耗时 | 文档整合进度 | 🟡 中 | Agent | 分批转换，优先关键文档（01/08/13） |
| RISK-002 | 12 号技术架构图过度设计（微服务） | 技术选型理解 | 🟢 低 | - | 已裁决：模块化单体 |
| RISK-003 | 13 号 Agent 工作流基于 LangGraph | Java 技术栈适配 | 🟡 中 | Agent | 需更新为 Spring AI 实现 |
...
| 里程碑 | 目标 | 计划日期 | 实际日期 | 状态 |
|--------|------|----------|----------|------|
| **M0：文档整合完成** | 15 份 docx 转为 md，总览/跟踪表就绪 | 2026-07-23 | - | 🔄 进行中 |
