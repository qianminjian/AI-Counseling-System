...
> 创建：2026-07-23 | 更新：2026-07-28（P2 §近期偏后完成：WB-003、TOOL-003、TTSFX-003、ORCH-008——628 测试全绿）
> 
...
| WB-001 | 教师工作台首屏（待办+时间线+概况条）+ 预警工作流（认领/处理/关闭 + SLA 逾期提醒） | 近期 | design/35 M1 | UX-002 | ✅ 后端 SLA 策略完成（2026-07-28，AlertSlaPolicy），前端 UI 增强待接线 |
| WB-002 | 学生详情页统一落地页 + 五角色字段裁剪 + 降噪（合并/聚合/静音） | 近期 | design/35 M2 | UX-002 | ✅ 后端 SLA 策略完成（2026-07-28），前端详情页待接线 |
