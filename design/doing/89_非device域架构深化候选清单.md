...
| 候选 | 状态 | 备注 |
|------|------|------|
| N-001 | 🟡 部分（2026-08-11） | AC-89-01/02 完成（805eacc LoginRateLimiter+家长端锁定）、AC-89-06 完成（7de2b0a TocAuthProvider 下沉）；AC-89-04/05/08 未做（双路径统一/AuthProvider 统一签发/四端回归） |
| N-002 | ⬜ 待议决 | 23 次变更热点 |
| N-003 | 🟡 部分（2026-08-11） | AC-89-03 验证通过（f57c6af withdrawn 现存生效）、AC-89-07 完成（7de2b0a 周报下沉）；AC-89-04 双路径统一未做（潜在旁路未收口） |
| N-004 | ⬜ 待议决 | 口径漂移 |
| N-005 | ⬜ 待议决 | 租户红线 |
