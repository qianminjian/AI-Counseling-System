...
export default function PlatformPanel() {
  ...
  const tenantColumns = [
    ...
    { title: '学校数', dataIndex: 'schoolCount', key: 'schools', width: 80, align: 'center' },
    { title: '学生数', dataIndex: 'studentCount', key: 'students', width: 80, align: 'center' },
    { title: '教师数', dataIndex: 'teacherCount', key: 'teachers', width: 80, align: 'center' },
    { title: '会话数', dataIndex: 'sessionCount', key: 'sessions', width: 80, align: 'center' },
