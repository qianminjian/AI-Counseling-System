...
import { parentRegister, parentLogin } from '../../api/index.js'
import { setToken, setRefreshToken, setUser, isAuthenticated } from '../../utils/auth.js'
        ...
        {mode === 'register' && (
          <div className="input-group">
            ...
            <input
              ...
              onChange={e => update('familyCode', e.target.value.toUpperCase())}
