...
class OpsInsightsServiceTest {
    ...
    void deadLedgerMasked() {
        ...
        // AUD-043：deadLedger 已改 selectPage（分页插件安全化），mock selectPage 返回台账页
        com.baomidou.mybatisplus.extension.plugins.pagination.Page<RiskEvent> page =
                new com.baomidou.mybatisplus.extension.plugins.pagination.Page<RiskEvent>(1, 200, false)
                        .setRecords(List.of(e));
        when(riskEventMapper.selectPage(any(), any(Wrapper.class))).thenReturn(page);
