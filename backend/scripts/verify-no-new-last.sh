...
# 已登记存量（实测 2026-08-12：19 个文件——OPS-P2-02/doing/96 台账对齐：
# 注释原写 14 个实列 18 项，且漏登 TeacherNoteStore/SummaryCompensationJob 致 CI 必红；
# 合法：常量值无注入面；收敛完成后逐步移除）
LEGACY=(
  ...
  "service/teacher/TeacherNoteStore.java"
  ...
  "service/conversation/SummaryCompensationJob.java"
